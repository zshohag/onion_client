                ...
                {loading ? (
                    ...
                    <>
                        <div className="flex flex-col items-center justify-center h-3/4 pt-24">
                            ...
                            <button className="bg-primary text-white px-8 py-2 focus:outline-none poppins rounded-full mt-24 transform transition duration-300 hover:scale-105" onClick={() => navigate('/')}>
                                Go back to home
                            </button>
                        </div>
                    </>
